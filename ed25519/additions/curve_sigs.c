...
void curve25519_private_keygen(const unsigned char* random,
                               unsigned char* curve25519_privkey_out)
{
  memmove(curve25519_privkey_out, random, 32);
  curve25519_privkey_out[0] &= 248;
  curve25519_privkey_out[31] &= 127;
  curve25519_privkey_out[31] |= 64;
}
